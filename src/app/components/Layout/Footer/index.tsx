...
import { Contact } from "@/app/types/profile";
  ...
  return (
    <footer>
          ...
          <div className="lg:col-span-4 col-span-1">
            <div className="flex gap-2">
              ...
              <p className="text-base font-normal text-offwhite">
                104B Ly Phuc Man, Tan Thuan Ward, Ho Chi Minh City
              </p>
            </div>
            ...
            <div className="flex gap-2 mt-10">
              ...
              <Link
                ...
                onClick={(e) => e.preventDefault()}
              >
                <p className="hover:text-primary dark:hover:text-primary">
      ...
      <div className="py-3">
        ...
        <p className="text-center">
          {`@${new Date().getFullYear()} - All Rights Reserved by hieu.tc`}
        </p>
      </div>
    </footer>
  );
